...
class DrawView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    private val mPaint: Paint = Paint() // Holds color and style info
    private val paths = ArrayList<Pen>() // Stores all strokes done by user
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // Iterate through list of paths and draw them all
        for (fp in paths) {
